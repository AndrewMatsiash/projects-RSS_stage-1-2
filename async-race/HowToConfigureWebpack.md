...
const renderImg = async (color: string) => `<svg class="icon-car"><use xlink:href="sprite.svg#car" fill="${color}"></use></svg>`;

const renderCar = async ({ id, name, color }) => {
  const carHtml = `
  ...
  <div class="road">
    <div class="launch-pad" >
      <div class="control-panel">
        ...
        <div class="car" id="car-${id}">${await renderImg(color)}</div>
      </div>
    </div>
...
const render = async () => {
  const html = `
    ...
    <form class="form" id="update">
      ...
      <input type="color" id="update-color" name="color" value="#fff">
    </form>
    <div class="race-controls">
      <button class="button race-btn" id="race">Race</button>
      <button class="button reset-btn" id="reset">Reset</button>
      <button class="button generator-btn" id="generator">Generator cars</button>
    </div>
    ...
    <div class="pagination">
      ...
      <button class="button prev-btn color" id="prev-btn">Next</button>
    </div>
`;
