...
export interface ISourcesRequestParameters {
  ...
  language?: "en";
  country?: 'ae' | 'ea' | 'ar' | 'ra' | 'at' | 'ta' | 'au' | 'ub' | 'be' | 'eb' | 'bg' | 'gb' | 'br' | 'rc' | 'ca' | 'ac' | 'ch' | 'hc' | 'cn' | 'nc' | 'co' | 'oc' | 'cu' | 'uc' | 'cz' | 'zd' | 'de' | 'ee' | 'eg' | 'gf' | 'fr' | 'rg' | 'gb' | 'bg' | 'gr' | 'rh' | 'hk' | 'kh' | 'hu' | 'ui' | 'id' | 'di' | 'ie' | 'ei' | 'il' | 'li' | 'in' | 'ni' | 'it' | 'tj' | 'jp' | 'pk' | 'kr' | 'rl';
...
export interface IArticles extends IEverythingSource {
